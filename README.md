...
综上所述，本项目的主要贡献如下：
(1) 我们提出了一种**面向多移动Agent**的**动态**服务需求路径规划框架，通过两阶段推理机制有效解决了物联网设备充电场景下的多机器人协同路径规划问题。
(2) 我们设计了**基于强化学习**的图划分网络，结合**多头注意力机制**，实现了对多Agent任务区域的合理划分，并提出了并行推理策略以提升模型训练与推理效率。
(3) 实验表明，我们的方法在动态服务需求的多旅行商问题中表现出优越的规划性能与高效的计算性能。得益于所提出的并行推理策略，我们的模型在保持高质量解的同时，5agents100TSP场景下**推理速度较基线方法提升了约73.5%(4.25s vs 16.02s)**，为物联网设备能源维护提供了高效、低成本的解决方案。
